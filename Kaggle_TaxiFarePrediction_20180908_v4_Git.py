...
plotly_apikey_path = os.path.join(r'C:\Users\', 'apikey_Plotly.txt')
...
mapbox_apikey_path = os.path.join(r'C:\Users\', 'apikey_Mapbox.txt')
...
#test_dist.to_csv(os.path.join(r'C:\Users'))
...
df_submit.to_csv(os.path.join(r'C:\Users'), index=False)
